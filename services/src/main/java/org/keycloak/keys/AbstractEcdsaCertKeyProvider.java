...
public abstract class AbstractEcdsaCertKeyProvider implements KeyProvider {
    ...
    public AbstractEcdsaCertKeyProvider(RealmModel realm, ComponentModel model) {
        this.model = model;
    ...
    protected KeyWrapper createKeyWrapper(KeyPair keyPair, String ecInNistRep, X509Certificate certificate) {
